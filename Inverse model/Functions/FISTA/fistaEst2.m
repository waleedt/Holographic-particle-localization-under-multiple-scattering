function [xhat, outs] = fistaEst2(forwardObj, tau, Holo2D, fileID, results_dir, varargin)
...
while(1)
    ...
    xhatnext_r = proxTV(real(s)-step*real(grad), step*tau, gradObj);
    xhatnext_i = proxTV(imag(s)-step*imag(grad), step*tau, gradObj);
    xhatnext = xhatnext_r + 1i*xhatnext_i;
