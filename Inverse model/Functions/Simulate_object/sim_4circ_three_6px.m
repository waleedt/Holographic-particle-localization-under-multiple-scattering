...
function f = sim_4circ_three_6px(nx,ny,nz,n_obj,n_medium,~)
...
r = (circ_size_px/2);
idx_x = [nx/2-r nx/2-r nx/2+r+dist_px nx/2+r+dist_px]; %center
idx_y = [ny/2-r ny/2+r+dist_px ny/2-r ny/2+r+dist_px]; %center
